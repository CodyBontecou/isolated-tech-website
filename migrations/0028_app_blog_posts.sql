...
CREATE INDEX IF NOT EXISTS idx_app_blog_posts_app ON app_blog_posts(app_id);
CREATE INDEX IF NOT EXISTS idx_app_blog_posts_published ON app_blog_posts(app_id, is_published, published_at);
CREATE INDEX IF NOT EXISTS idx_app_blog_posts_slug ON app_blog_posts(app_id, slug);
