...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description:
      "Portfolio platform for UGC creators. Custom sites, zero hosting friction, built-in analytics and contact forms.",
  ...
  },
  {
    ...
    description:
      "Modern Pilates studio website for Talasofilia in Puerto Escondido. Class booking, pricing, and a clean design focused on mindful movement.",
