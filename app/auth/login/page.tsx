...
export default function LoginPage({
  ...
  const oauthQuery = new URLSearchParams({ redirect: redirectTo }).toString();
    ...
    <div className="auth-page">
      <div className="auth-card">
        ...
        <div className="auth-oauth-buttons">
          <a href={`/api/auth/github?${oauthQuery}`} className="auth-oauth-btn">
          ...
          <a href={`/api/auth/google?${oauthQuery}`} className="auth-oauth-btn">
            <svg viewBox="0 0 24 24" fill="currentColor">
          ...
          <a href={`/api/auth/apple?${oauthQuery}`} className="auth-oauth-btn">
            <svg viewBox="0 0 24 24" fill="currentColor">
